...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--unlabeled_criterion", type=str, default='nn.BCELoss(reduction="none")'
    )
    parser.add_argument(
        "--models", type=str, default="PretrainedResnetClassifier(18,2)"
    )
    ...
    if args["preset"] != "":
        ...
        if args["preset"] in presets.keys():
            ...
            print(
                "No preset named {} found in {}. Sorry, bye!".format(
                    args["preset"], experiment_presets_file
                )
            )
            exit()
    ...
    args["container"] = Container(
        dr=args["data"],
        labeled_mix_rate=args["mix_rates"][0],
        unlabeled_mix_rate=args["mix_rates"][1],
